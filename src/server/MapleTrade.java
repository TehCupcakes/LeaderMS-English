...
public class MapleTrade {
	...
	public void complete2() {
		...
		for (IItem item : exchangeItems) {
			MapleInventoryManipulator.addFromDrop(chr.getClient(), item, "Completed trade with " + partner.getChr().getName() + ". " + chr.getName() + " received the item.", false);
		}
		if (exchangeMeso > 0)
...
//	}
	...
	public static void inviteTrade(MapleCharacter c1, MapleCharacter c2) {
             ...
             c1.getClient().getSession().write(MaplePacketCreator.serverNotice(5, "GameMasters JR's nao podem realizar trocar."));
             return;
       }
		if (c2.getTrade() == null) {
