...
public class AutobanManager {
    ...
    public void addPoint(AutobanFactory fac, String reason) {
        ...
        if (points.get(fac) >= fac.getMaximum()) {
            chr.autoban("Autoban for " + fac.name() + " ;" + reason, 1);
            chr.sendPolice("You have been blocked by #bLeaderBOT#k for hacking!");
        }
    }
    ...
    public void resetMisses() {
        ...
        if (samemisscount > 4)
            chr.autoban("Autoban for : " + misses + " ; Miss godmode", 1);
