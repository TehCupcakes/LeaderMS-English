		...
		if (mode == 1)
			...
			if (playerStatus) { // party leader
				if (status == 0) {
					...
					if (preamble == null) {
						cm.sendNext("Hello, and welcome to the seventh stage of Ludibrium PQ. There are #r3#k #bPasses#k to be collected in here. You need a Bowman or Thief with max Keen Eyes or Eye of the Amazon. Kill the monsters up there, and a Rombot will spawn somewhere in the map. Kill the Rombot to retrieve the pass. Collect for me 3 Pass, and I will open the portal.");
						...
						cm.dispose();
							...
							if (cm.haveItem(4001022, 3) == false) {
								cm.sendNext("I'm sorry, but you do not have all 3 passes needed to clear this stage.");
								cm.dispose();
							}
							else {
