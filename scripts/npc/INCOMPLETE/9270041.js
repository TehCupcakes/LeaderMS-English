...
function action(mode, type, selection) {
	...
	if (status == 0) {
		cm.sendSimple("Hello there~ I am #p"+cm.getNpc()+"# from Singapore Airport. I was transferred to #m103000000# to celebrate new opening of our service! How can i help you?\r\n#L0##bI would like to buy a plane ticket to Singapore#k#l\r\n#L1##bLet me go in to the departure point.#k#l");
	} else if (status == 1) {
		menu = selection;
		if (menu == 0) {
