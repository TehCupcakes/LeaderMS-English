		...
		else if (status == 1)
		{
			...
			if (selection == 0)
			{
				if (cm.getPlayer().getGuildId() > 0)
				{
					...
					cm.sendYesNo("Creating a Guild costs #b" + cm.getPlayer().guildCost() + " mesos#k, are you sure you want to continue?");
			}
			else if (selection == 1)
			{
			...
			else if (selection == 2)
			{
				if (cm.getPlayer().getGuildId() <= 0 || cm.getPlayer().getGuildRank() != 1)
				{
					...
					cm.sendYesNo("Increasing your Guild capacity by #b5#k costs #b" + cm.getPlayer().capacityCost() + " mesos#k, are you sure you want to continue?");
			}
		}
		else if (status == 2)
		{
